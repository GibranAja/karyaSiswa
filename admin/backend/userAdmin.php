    ...
    <aside class="bg-green-800 text-white h-screen w-[15%] fixed top-0 left-0 z-10">
        <div class="p-5">
            ...
            <ul class="mt-5">
                ...
                <li class="mb-3">
                    <a href="#" class="block py-2 px-4 hover:bg-green-700">Users</a>
                </li>
                <li class="mb-3">
                    <a href="#" class="block py-2 px-4 hover:bg-green-700">Rooms</a>
                </li>
                <li class="mb-3">
                    <a href="#" class="block py-2 px-4 hover:bg-green-700">Bookings</a>
                </li>
            </ul>
        </div>
    </aside>
