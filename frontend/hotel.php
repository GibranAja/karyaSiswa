...
<body class="scroll-behavior overflow-x-hidden">
  <header id="navbar" class="bg-green-800 text-white px-4 md:px-32 py-5 flex items-center justify-between fixed top-0 w-full z-10">
    <form action="./index.php" class="text-2xl md:text-4xl font-bold mr-4 md:mr-10">
      <p type="submit" class="text-[#FFB000]">Hai<span class="text-[#F5F5DC]">loka</span></p>
    </form>
